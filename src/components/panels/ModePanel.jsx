...
import { Wallet, Zap, UserMinus, Search, MessageCircleHeart, Gift, Swords, ChevronDown, ChevronUp } from 'lucide-react'
  ...
  return (
    <section className={styles.panel} aria-labelledby="mode-heading">
      ...
      >
        ...
        {isOpen ? <ChevronUp size={18} className={styles.toggleIcon} /> : <ChevronDown size={18} className={styles.toggleIcon} />}
      </div>
